    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <Link
            to="/reset-password"
            className="text-[10px] mono tracking-[0.2em] uppercase text-[var(--color-accent-secondary-text)] hover:text-[var(--color-accent-text)] transition-colors"
          >
            Forgot?
          </Link>
        </div>
      ...
      <p className="text-center text-sm text-[var(--color-text-muted)]">
        ...
        <button
          ...
          className="text-[var(--color-accent-secondary-text)] hover:text-[var(--color-accent-text)] font-medium transition-colors animate-press"
        >
          Sign up
        </button>
      </p>
