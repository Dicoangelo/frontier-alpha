...
Copy-paste this into your the AI agent terminal session to begin Phase 1:
...
Then in next session, the AI assistant can read this and continue seamlessly.
...
5. **Document blockers** - Help next session (or next the AI assistant) understand issues
6. **Take checkpoints** - At end of each task, commit with descriptive message

---

**Ready to start?** Copy the kickoff prompt above into your the AI agent session! 🚀
